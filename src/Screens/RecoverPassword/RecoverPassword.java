/*
	cSpell:ignore desencriptar operacion verificacion boton codigo tahoma 
...
public class RecoverPassword extends javax.swing.JFrame {
        ...
        private String obtenerNombre(String correo) throws SQLException {
                ...
                return (String) (OperacionCRUD.seleccionar(
                                String.format("SELECT nombre_usuario FROM jugadores WHERE correo_jugador = '%s'",
                                                correo),
                                new String[] { "nombre_usuario" })).get(0).get(0);
